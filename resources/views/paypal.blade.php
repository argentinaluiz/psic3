...
<input type="hidden" name="quantity_{{$count}}" value="{{ $item->model->qty }}">
...
<button type="submit" id="complete-order" class="button-primary full-width">Finalizar a compra</button>
<input name="submit" id="paypalbtn" class="button-primary full-width" value="PayPal" formaction="https://www.paypal.com/cgi-bin/webscr">
