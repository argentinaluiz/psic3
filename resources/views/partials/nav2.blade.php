<!-- Off-Canvas Mobile Menu-->
    <div class="offcanvas-container" id="mobile-menu">
      <nav class="offcanvas-menu">
        <ul class="menu">
            <li><a class="page-scroll active" href="/"><span> {{ trans ('app.Home') }} </span></a></li>
            <li><a class="page-scroll" href="/"><span> {{ trans ('app.Packages') }} </span></a></li>
            <li><a class="page-scroll" href="/"><span> {{ trans ('app.Contact') }} </span></a></li>
        </ul>
      </nav>
    </div>
    <!-- Topbar-->
