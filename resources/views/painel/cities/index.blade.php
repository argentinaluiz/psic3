...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3>Cidades do Estado: <strong>{{$state->name}} </strong> - {{$cities->count()}}</h3>
...
<script>$(document).ready(function () {
    $.noConflict();
		var table = $('.dataTables-cities').DataTable({
			pageLength: 10,
			responsive: true,
			...
			buttons: [
				{extend: 'copy'},
				{extend: 'csv'},
				{extend: 'excel', title: 'CidadesFile'},
				{extend: 'pdf', title: 'CidadesFile'},
