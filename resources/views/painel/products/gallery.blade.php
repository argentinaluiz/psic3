...
@section('content')
	<span class="pull-right small text-muted">Total de imagens: {{ $totalGalleries}}</span>
	<br/>
	@can('products-create')
		<a class="btn btn-sm btn-primary" href="{{route('products.gallery.edit',$carro)}}"><span class="glyphicon glyphicon-plus"></span> Adicionar</a>
	@endcan
