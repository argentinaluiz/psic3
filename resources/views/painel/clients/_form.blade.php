...
@component('form._form_group',['field' => 'expertise'])
    {{ Form::label('expertise', 'Área de atuação',['class' => 'control-label']) }}
    {{
...
@if($clientType == \App\Models\Painel\Client::TYPE_INDIVIDUAL)
