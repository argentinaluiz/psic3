...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <!-- Modernizr-->
    <script type="text/javascript" src="{{ asset('site/js/jquery-3.2.1.min.js') }}"></script>
  ...
  <body id="page-top">
    ...
    <div class="offcanvas-container" id="mobile-menu">
      <nav class="offcanvas-menu">
        <ul class="menu">
            <li><a class="page-scroll active" href="{{ route('login') }}"><span> HOME </span></a></li>
    ...
    <header class="navbar navbar-sticky">
      ...
      <nav class="site-menu">
        <ul>
            <li><a class="page-scroll active" href="{{ url('/login') }}"><span> HOME </span></a></li>
            <li><a class="page-scroll" href=""><span> PACKAGES </span></a></li>
            <li><a class="page-scroll" href="#contact"><span> CONTACT </span></a></li>
        </ul>
      </nav>
      <!-- Toolbar-->
              ...
              <div class="margin-top-1x hidden-md-up"></div>
                  <form class="subscribe-form" action="" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                      <div class="input-field">
                          <input type="email" id="mce-EMAI" name="EMAIL">
                        ...
                        <button class="btn btn-primary" id="mc-embedded-subscribe" type="submit" style="margin-top: -60px;"><i class="icon-check"></i></button>
                      </div>
                  </form>
            </div>
          </div>
